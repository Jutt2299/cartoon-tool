...
def check_kaggle_output():
    ...
    result = subprocess.run(["kaggle", "kernels", "output", f"{username}/cartoon-video-generator"], capture_output=True, text=True)
    print("Kernel Output:")
    print(result.stdout)
    if result.stderr:
