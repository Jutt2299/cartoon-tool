...
cell3 = {
    ...
    'source': [
        ...
        '    # P100 GPU (sm_60) does not support Flash Attention 2\n',
        '    # Force math-based attention for compatibility\n',
        '    torch.backends.cuda.enable_flash_sdp(False)\n',
        '    torch.backends.cuda.enable_mem_efficient_sdp(False)\n',
        '    torch.backends.cuda.enable_math_sdp(True)\n',
        '    print("Flash Attention disabled for P100 compatibility")\n',
        ...
        '        try:\n',
        '            # LTX-Video blue screen fix - use correct parameters\n',
        '            # LTX-Video needs guidance_scale between 3.0-4.5, num_frames must be 8N+1\n',
        '            result = pipe(\n',
