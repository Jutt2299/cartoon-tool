...
cell1 = {
    ...
    'source': [
        ...
        '    "--target", PKGS,\n',
        '    "diffusers==0.33.1", "transformers", "accelerate", "sentencepiece"], check=True)\n',
...
cell3 = {
    ...
    'source': [
        ...
        '# Import LTXVideoPipeline - try direct submodule path as fallback\n',
        'try:\n',
        '    from diffusers import LTXVideoPipeline\n',
        'except ImportError:\n',
        '    from diffusers.pipelines.ltx import LTXVideoPipeline\n',
        'from diffusers.utils import export_to_video\n',
        'from pyngrok import ngrok\n',
        'print("Diffusers version in Cell 3:", __import__("diffusers").__version__)\n',
        'print("LTXVideoPipeline loaded:", LTXVideoPipeline)\n',
        '\n',
        'try:\n',
        '    from kaggle_secrets import UserSecretsClient\n',
        '    user_secrets = UserSecretsClient()\n',
