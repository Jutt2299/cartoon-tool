...
cell1 = {
    ...
    'source': [
        ...
        '# Install our own diffusers version to a custom dir to bypass system version\n',
        '!pip install -q --target={PKGS} "diffusers>=0.32.0" transformers accelerate sentencepiece\n',
