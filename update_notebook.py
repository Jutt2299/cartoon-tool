...
cell2 = {
    ...
    'source': [
        ...
        '\n',
        'if hf_token == "__HF_TOKEN_PLACEHOLDER__" or not hf_token:\n',
        '    hf_token = None\n',
        '\n',
        'try:\n',
        '    from kaggle_secrets import UserSecretsClient\n',
        ...
        '    print("CRASH ERROR IN DOWNLOAD:", error_msg)\n',
        '    requests.post(backend_url, json={"account_username": kaggle_user, "url": f"ERROR: Download Failed - {str(e)}"})\n',
        '    raise e\n'
    ]
}
